 ...
 *
 */
public class OnlinePayCashierRequestDTO {
	...
	// 返回对象
	private OnlinePayCashierResponseDTO onlinePayCashierResponseDTO;
	...
	public OnlinePayCashierResponseDTO getOnlinePayCashierResponseDTO() {
		return onlinePayCashierResponseDTO;
	}

	public void setOnlinePayCashierResponseDTO(OnlinePayCashierResponseDTO onlinePayCashierResponseDTO) {
		this.onlinePayCashierResponseDTO = onlinePayCashierResponseDTO;
	}
