/**
 *  File: OrderTodoManageController.java
 *  Date: 2016年5月26日
 *  Author: chaoyue 
 *  Changes: Create
 ...
 * 待处理订单管理控制器
 */
public class OrderTodoManageController extends MultiActionController {
	...
	public ModelAndView search(HttpServletRequest request,
		...
		orderCriteria.setItemStatus("0");
		Page page = PageUtils.getPage(request); // 分页
