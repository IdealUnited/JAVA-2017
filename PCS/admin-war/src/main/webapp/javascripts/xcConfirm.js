...
(function($){
	...
	window.wxc.xcConfirm = function(popHtml, type, options) {
		...
		var iconn = config.iconn;
		var $iconn = iconn ? $("<div>").addClass("bigIconn").css("backgroundPosition",iconn) : "";
		...
		function creatDom(){
			$popBox.append(
				...
				$txtBox.append($iconn).append($txt)
			).append(
