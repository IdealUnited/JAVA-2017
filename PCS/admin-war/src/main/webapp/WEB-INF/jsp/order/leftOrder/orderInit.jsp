...
<script type="text/javascript">
	...
	function query(pageNo, totalCount, pageSize) {
		...
		var pars = $("#userSearchForm").serialize() + "&pageNo=" + pageNo
				+ "&totalCount=" + totalCount + "&pageSize=" + pageSize;
		$.ajax({
			type : "POST",
			url : "${ctx}/leftExpressOrder.do?method=search",
			data : pars,
...
<body>
	<table width="25%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td height="18">
				<div align="center">
					<font class="titletext">结余订单查询</font>
				</div>
			</td>
		</tr>
		<tr>
	...
	<form id="userSearchForm">
		<table border="0" style="width: 900px;" class="inputTable"
			align="center" cellpadding="4" cellspacing="0">
			<tr>
				<td style="text-align: right;">订单号:</td>
				<td class="textLeft"><input type="text" name="orderId"
					id="orderId" style="width: 100px;" /></td>
				<td style="text-align: right;">渠道订单号:</td>
				<td class="textLeft"><input type="text"
					name="channelOrderItemId" id="channelOrderItemId"
					style="width: 100px;" /></td>
			</tr>
			<tr>
				<td style="text-align: right;">交易创建时间:</td>
				<td class="border_top_right4" colspan="3"><input class="Wdate"
					type="text" id="beginTime" value="${beginTime}" name="beginTime"
			...
			<tr>
				<td style="text-align: center; height: 35px;" colspan="6"><a
					href="#" class="dialog_link ui-state-default ui-corner-all"
					onclick="query()"> <span class="ui-icon ui-icon-search"></span>&nbsp;查&nbsp;&nbsp;询&nbsp;
				</a></td>
			</tr>
		</table>
	</form>
	<!-- <div align="right">
		...
		&nbsp;&nbsp;&nbsp;&nbsp; <a href="#"
			class="dialog_link ui-state-default ui-corner-all"> <span
			class="ui-icon ui-icon-search"></span>费用试算
		</a>-->
	</div>
