	...
	<body>
		<table width="25%" border="0" cellspacing="0" cellpadding="0" align="center" height="21">
			...
			<tr>
				<td height="18">
					<div align="center">
						<font class="titletext">待处理订单</font>
					</div>
				</td>
			</tr>
			<tr>
		...
		<table border="0" style="width: 900px; " class="inputTable" align="center" cellpadding="3" cellspacing="0">
			...
			<tr>
				...
				<td style="text-align:right;">预计物流成本：</td>
				<td class="textLeft">
					<select name="costOperator" id="costOperator" style="width: 100px;">
						<option value="">请选择</option>
						<option value=">=">大于等于</option>
						<option value="<=">小于等于</option>
					</select>
					<input type="text" name="cost" id="cost" style="width: 100px;"/>
				</td>
			</tr>
			<tr>
				<td style="text-align:right;">预计毛利：</td>
				<td class="textLeft">
					<select name="profitOperator" id="profitOperator" style="width: 100px;">
						<option value="">请选择</option>
						<option value=">=">大于等于</option>
						<option value="<=">小于等于</option>
					</select>
					<input type="text" name="profit" id="profit" style="width: 100px;"/>
				</td>
		...
		<div align="right">
			...
			<a href="#" class="dialog_link ui-state-default ui-corner-all" onclick="process(2)">
				<span class="ui-icon ui-icon-search"></span>批量滞留
			</a>
			&nbsp;&nbsp;&nbsp;&nbsp;
