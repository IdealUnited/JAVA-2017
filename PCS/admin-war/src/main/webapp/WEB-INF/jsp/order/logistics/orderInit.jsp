	...
	<head>
		...
		<script type="text/javascript">
			...
			function query(pageNo,totalCount,pageSize) {
				...
				$.ajax({
					type: "POST",
					url: "${ctx}/createExpressOrder.do?method=search",
					data: pars,
	...
	<body>
		<table width="25%" border="0" cellspacing="0" cellpadding="0" align="center" height="21">
			...
			<tr>
				<td height="18">
					<div align="center">
						<font class="titletext">待发货订单</font>
					</div>
				</td>
			</tr>
			<tr>
		...
		<table border="0" style="width: 900px; " class="inputTable" align="center" cellpadding="3" cellspacing="0">
			...
			<tr>
				...
				<td style="text-align:right;">最长边：</td>
				<td class="textLeft">
					<select name="longestSideOperator" id="longestSideOperator" style="width: 100px;">
						<option value="">请选择</option>
						<option value=">=">大于等于</option>
						<option value="<=">小于等于</option>
					</select>
					<input type="text" name="longestSide" id="longestSide" style="width: 100px;"/>&nbsp;厘米(cm)
				</td>
				...
				<td class="textLeft">
					...
					<input type="text" name="weight" id="weight" style="width: 100px;"/>&nbsp;克(g)
				</td>
			</tr>
			<tr>
