	...
	<head>
		...
		<script type="text/javascript">
			...
			function query(pageNo,totalCount,pageSize) {
				...
				$.ajax({
					type: "POST",
					url: "${ctx}/productType.do?method=search",
					data: pars,
	...
	<body>
		<table width="25%" border="0" cellspacing="0" cellpadding="0" align="center" height="21">
			...
			<tr>
				<td height="18">
					<div align="center">
						<font class="titletext">产品类别维护</font>
					</div>
				</td>
			</tr>
			<tr>
		...
		<table border="0" style="width: 700px; " class="inputTable" align="center" cellpadding="3" cellspacing="0">
			<tr>
				...
				<td class="textLeft">
					<input type="text" name="enType" id="enType" style="width: 100px;" />
				</td>
			</tr>
			
			<tr>
				<td style="text-align:center; height: 35px;" colspan="4">
					<a href="${ctx}/productType.do?method=addInit" class="dialog_link ui-state-default ui-corner-all">
