package com.idealunited.inf.scheduling.quartz;
	...
	public static class BeanInvokingJob implements Job
	{
		...
		public void execute(JobExecutionContext context) throws JobExecutionException
		{
			try
			{
				...
				if(targetBean==null)
					throw new JobExecutionException(new Exception("targetBean cannot be null."), false);
				
				String targetMethod = context.getMergedJobDataMap().getString("targetMethod");
				logger.debug("targetMethod is "+targetMethod);
				if(targetMethod==null)
					throw new JobExecutionException(new Exception("targetMethod cannot be null."),false);
